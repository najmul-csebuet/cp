...
public class P57 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        boolean fileInOut = !P57.class.getPackage().getName().isEmpty();
    ...
    public void solution(long fd) {
        long l = 0, r = (int) Math.sqrt(1e18) + 1;
        while (l <= r) {
            long midX = l + (r - l) / 2;
            long value = midX * (midX + 100) + (long) Math.floor(midX / 3.0);
            if (value == fd) {
                io.println(midX);
                return;
            }
