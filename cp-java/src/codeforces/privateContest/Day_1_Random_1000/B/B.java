package codeforces.privateContest.Day_1_Random_1000.B;
...
public class B {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int t = 1; t <= totalTC; t++) new Solution().solve(io.nextInts());
        FastIO.verifyOutput();
    }
    ...
    static class FastIO extends PrintWriter {
        ...
        public FastIO(boolean fileInOut) throws IOException {
            super(fileInOut ? new FileOutputStream("out.txt") : System.out, true);
            br = new BufferedReader(new InputStreamReader(fileInOut ? B.class.getResourceAsStream("in.txt") : System.in));
            //br = new BufferedReader(new InputStreamReader(fileInOut ? new FileInputStream("in.txt") : System.in));
            out = new PrintWriter(new BufferedOutputStream(fileInOut ? new FileOutputStream("out.txt") : System.out), true);
        }

        public static FastIO getFastIO() throws IOException {
        ...
        public static void verifyOutput() throws IOException {
            ...
            String file = B.class.getResource("ans.txt").getFile();
            String[] ansFileText = Files.readAllLines(Path.of(file)).toArray(new String[0]);
...
class Solution {
    public void solve(Integer[] integers) {
