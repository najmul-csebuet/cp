...
public class C1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        boolean fileInOut = C1.class.getPackage() != null;

        Scanner sc = new Scanner(new BufferedReader(new InputStreamReader(fileInOut ? C1.class.getResourceAsStream("in.txt") : System.in)));
        ...
        if (fileInOut) {
            ...
            BufferedReader reader1 = new BufferedReader(new FileReader(C1.class.getResource("ans.txt").getFile()));
