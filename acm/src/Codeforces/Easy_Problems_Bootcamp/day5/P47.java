...
public class P47 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        boolean fileInOut = !P47.class.getPackage().getName().isEmpty();
    ...
    public void solution(int n) {
        // n is a fib number
        if (n <= 1) {
            io.println(String.format("0 0 %d", n));
            return;
        }

        if (n <= 3) {
            io.println(String.format("%d 1 1", n - 2));
            return;
        }

        // divide it in a, b, c. they can be same fib number
        ...
        --i;
        io.println(fib.get(i - 4) + " " + fib.get(i - 3) + " " + fib.get(i - 1));
    }
