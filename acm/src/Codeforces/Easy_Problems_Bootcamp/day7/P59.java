...
public class P59 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        boolean fileInOut = !P59.class.getPackage().getName().isEmpty();
    ...
    public void solution() {
        ...
        while (true) {
            ...
            int subAmount = min - min % A.length;
            if (min <= A.length) subAmount = A.length;
            for (int i = 0; i < A.length; i++) A[i] -= subAmount;
            min -= subAmount;
        }
    }
