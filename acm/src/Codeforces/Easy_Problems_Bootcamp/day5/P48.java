...
public class P48 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        boolean fileInOut = !P48.class.getPackage().getName().isEmpty();
    ...
    public void solution(int n, int p) {
        /*
            N  people are standing in the line. We enumerate them from left to right, so i-th person is standing on the i-th position. How many ways can we rearrange these people in such a way that every person stays in the same place or on one of the adjacent ones? Output a result modulo some number P.

            Input
            A single line contains two integers N (1≤N≤1000000), the number of people in the line and P (2≤P≤1000000010).

            Output
            Output a single integer, a number of ways modulo P.
         */
