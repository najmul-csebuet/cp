package codeforces.privateContest.Day_1_Random_1000.C;
...
public class C {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int t = 1; t <= totalTC; t++) new Solution().solve();
        FastIO.verifyOutput();
    }
    ...
    private static class FastIO extends PrintWriter {
        ...
        public FastIO(boolean fileInOut) throws FileNotFoundException {
            ...
            // local in file
            br = new BufferedReader(new InputStreamReader(fileInOut ? C.class.getResourceAsStream("in.txt") : System.in));
        ...
        public static void verifyOutput() throws IOException {
            ...
            // local ans file
            String file = C.class.getResource("ans.txt").getFile();
            String[] ansFileText = Files.readAllLines(Paths.get(file)).toArray(new String[0]);
