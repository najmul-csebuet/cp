...
public class P37 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        boolean fileInOut = !P37.class.getPackage().getName().isEmpty();
    ...
    public void solution(int[] a) {
        ...
        for (int i = 0; i < a.length; i++) {
            if (a[i] < 0) isNegativeCountOdd = !isNegativeCountOdd;
            else if (a[i] == 0) hasAnyZero = true;
            ans += Math.abs(Math.abs(a[i]) - 1);
        }

        io.println(!isNegativeCountOdd || hasAnyZero ? ans : ans + 2);
    }
