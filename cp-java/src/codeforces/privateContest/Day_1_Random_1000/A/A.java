package codeforces.privateContest.Day_1_Random_1000.A;
...
public class A {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int t = 1; t <= totalTC; t++) new A().solution();
        FastIO.verifyOutput();
    }
    ...
    private static class FastIO extends PrintWriter {
        ...
        public FastIO(boolean fileInOut) throws FileNotFoundException {
            ...
            //br = new BufferedReader(new InputStreamReader(fileInOut ? A1.class.getResourceAsStream("in.txt") : System.in))
        ...
        public static FastIO getFastIO() throws FileNotFoundException {
            fileInOut = !A.class.getPackage().getName().isEmpty();
        ...
        public static void verifyOutput() throws IOException {
            ...
            //BufferedReader reader1 = new BufferedReader(new FileReader(A1.class.getResource("ans.txt").getFile()));
